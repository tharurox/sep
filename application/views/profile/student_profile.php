            ...
            <div class="col-md-12" style="margin-top: 10px;">
                <div class="bhoechie-tab-menu">
                    <ul class="nav nav-tabs profile-nav">
                        <li role="presentation" <?php if (($prof_navbar = 'profile_s') || ($prof_navbar = 'profile_t') || ($prof_navbar = 'profile_a')) {
    echo 'class="active"';
} ?>><a href="#">Personal Details</a></li>
...
<?php if (isset($complain)) { ?> <li role="presentation"><a href="<?php ?>">Add Note</a></li> <?php } ?>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="details-table" style="margin-top: 10px; margin-bottom: 10px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="normal"><?php if ($personal->language == 's') {
    echo 'Sinhala';
}if ($personal->language == 'e') {
    echo 'English';
}if ($personal->language == 't') {
    echo 'Tamil';
} ?></td>
                                <td class="subheadng">Religion</td>
                                <td class="normal"><?php if ($personal->religion == 1) {
    echo 'Buddhism';
}if ($personal->religion == 2) {
    echo 'Hinduism';
}if ($personal->religion == 3) {
    echo 'Islam';
}if ($personal->religion == 4) {
    echo 'Catholicism';
}if ($personal->religion == 5) {
    echo 'Christianity';
}if ($personal->religion == 6) {
    echo 'Other';
} ?></td>
                            </tr>
                            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="details-table" style="margin-top: 10px; margin-bottom: 10px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="normal"><?php if ($guardian->relation == 'f') {
    echo 'Father';
}if ($guardian->relation == 'm') {
    echo 'Mother';
}if ($guardian->relation == 'g') {
    echo 'Guardian';
} ?></td>
                            </tr>
                            <tr>
    ...
    echo 'Male';
                                ...
                                <td class="normal"><?php if ($guardian->is_pastpupil == 1) {
    echo 'Yes';
}if ($guardian->is_pastpupil == 0) {
    echo 'No';
} ?></td>
                            </tr>
                            <tr>
