        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
			  <div class="panel-heading">
			    <strong>ASSSING BATCH</strong>
			  </div>
			  <div class="panel-body">
			  
			  <div class="row">
			   	<div class="col-md-12">
			   		<h4>Pending Students without Batch</h4><hr>
			   	</div>
			   </div>
			   <?php 
			   		$attributes = array('class' => '', 'name' => 'pendinglist');
			   		echo form_open('classes/assign_batch/', $attributes); ?>
			   <div class="row">
				   	...
				   	<div class="col-md-4">
						...
						<div class="row" style="margin-top:10px">
							<div class="col-md-12">	
								<button type="submit" name="submit" onclick="selectAll();" id="submit" class="btn btn-success">Assign to Batch</button>
							</div>
						</div>
