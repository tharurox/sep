<div class="container">
  <div class="row">
    ...
    <div class="panel panel-info">
        ...
        <?php echo form_open('certificate/report_pdf_leaving', $attributes); ?>
          ...
          <div class="media">
              ...
              <div class="media-body">
                  <h4 class="media-heading">Leaving Certificate</h4>
                        The character certificate can be genarated using the student id or the student name.Other fields are automaticaly genarated.Because of that
                        you can easily genarate reports and print reports
              </div>
            </div>
...
<script type="text/javascript">
    ...
    function abc() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/certificate/generate_leaving/",
            type: 'POST',
            data: formdata,
            processData: false,
            contentType: false,
