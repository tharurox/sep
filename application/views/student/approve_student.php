                            ...
                            $(document).ready(function () {
                                ...
                                if (type == 'A') {
                                    abuttons = ' <a href="" class="btn btn-raised btn-primary btn-xs" id="view" data-toggle="tooltip" title="view"><i class="fa fa-eye"></i></a>  &nbsp; \n\
                                                <a href="" class="btn btn-raised btn-primary btn-xs" id="approve" data-toggle="tooltip" title="approve"><i class="fa fa-gift"></i></a>  &nbsp; \n\
                                ...
                                var table = $('#table_id').DataTable({
                                    "ajax": "<?php echo base_url(); ?>index.php/student/load_Temp_student_datatble",
                                    "columns": [
                                        {"data": "id"},
                                        {"data": "id2"},
                                        {"data": "admission_no"},
                                ...
                                $('#table_id tbody ').on('click', '#view', function (e) {
                                    ...
                                    window.location.href = "<?php echo base_url("index.php/profile/loadProfile_temp"); ?>"+"?key=" + data['id2'];
                                });
                                $('#table_id tbody ').on('click', '#approve', function (e) {
                                    e.preventDefault();
                                    var data = table.row($(this).parents('tr')).data();
                                    confirmApprove(data['id2']);
                                  //  window.location.href = "<?php echo base_url("index.php/student/approve_student"); ?>"+"?key=" + data['id2'];
                                });
                                $('#table_id tbody ').on('click', '#edit', function (e) {
                                    e.preventDefault();
                                    var data = table.row($(this).parents('tr')).data();
                                    window.location.href = "<?php echo base_url("index.php/student/load_Temp_student"); ?>"+"/" + data['id2'];
                                });
                                $('#table_id tbody ').on('click', '#delete', function (e) {
                                    e.preventDefault();
                                    var data = table.row($(this).parents('tr')).data();
                                    deleteUser(data['id2']);
        //                            window.location.href = "<?php echo base_url("index.php/student/archive_student_inTemp/"); ?>"+ data['id2'];
                                });
                            });
                            ...
                            function deleteUser(userId) {
                                swal({
                                    ...
                                    window.location.href = "<?php echo base_url("index.php/student/archive_student_inTemp"); ?>" + "/" + userId;
                                });
                            }
                             ...
                             function confirmApprove(userId) {
                                swal({
                                    ...
                                    window.location.href = "<?php echo base_url("index.php/student/approve_student"); ?>" + "/" + userId;
                                });
                            }
                        </script>
