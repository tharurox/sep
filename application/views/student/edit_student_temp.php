    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div >
                    ...
                    echo form_open('princ_approval/edit_student', $attributes);
                    ?>
                ...
                <div class="panel panel-warning" style="background-color: #fef7ee">
                    ...
                    <div class="col-md-3 col-md-push-1  form-group">
                                ...
                                <input type="text" name="studentid" value="<?php echo $result->user_id; ?>" class="form-control warning " id="studentid" readonly>
                     ...
                     <div class="col-md-3 col-md-offset-4 form-group">
                                ...
                                <input type="text" name="admissionno" value="<?php echo $result->admission_no; ?>" class="form-control warning " id="admissionno" readonly>
                                <div><?php echo form_error('admissionno'); ?></div>
                     </div>
             ...
             <div class="panel  panel-info"  >
                 <div class="panel-heading panel-info " >
                    ...
                    <span class="pull-right">
                        <a href="<?php echo base_url("index.php/student/load_temp_guardian") . "/" .$result->user_id;?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-raised btn-xs btn-primary"><i class="">Guardian Details</i></a>
                ...
                <!-- first row-->
                 <div class="row">
                    ...
                    <div class="col-md-5 col-md-push-1 form-group">
                                ...
                                <input type="text" name="fullname" value="<?php echo $result->full_name; ?>" class="form-control" id="fullname" placeholder="Full Name" >
                     ...
                     <div class="col-md-5 col-md-push-1 form-group">
                                ...
                                <input type="text" name="initials" value="<?php echo  $result->name_with_initials; ?>" class="form-control" id="fullname" placeholder="Name_With_Initials" >
