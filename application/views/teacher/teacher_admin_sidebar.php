        ...
        <div id="collapseOne" class="panel-collapse collapse in">
            <div class="panel-body">
                <table class="table">
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-repeat text-primary"></span><a href="#leavestatus">Add Teacher</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div id="collapseTwo" class="panel-collapse collapse">
            <div class="panel-body">
                <table class="table">
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-wrench text-warning"></span><a href="#">Leave Types</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
