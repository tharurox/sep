                    ...
                    <div class="panel-body">
                        ...
                        <table id="example" class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="<?php echo base_url("index.php/profile/loadProfile_temp_teacher")."?key=". $row->id;?>" class="btn btn-raised btn-primary btn-xs" aria-hidden="true"><i class="fa fa-eye"></i></a>
                               ...
                               <a id="accept-user" data-user-id="<?php echo $row->id; ?>" class="btn btn-raised btn-primary btn-xs app" aria-hidden="true"><i class="fa fa-trash"></i></a>
                                ...
                                <a href="<?php echo base_url("index.php/teacher/load_teacher_temp") . "/" . $row->id; ?>" class="btn btn-raised btn-primary btn-xs" aria-hidden="true"><i class="fa fa-edit"></i></a>&nbsp;
